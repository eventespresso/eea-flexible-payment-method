EE Flexible Payment Method Add-on
=========

[![Latest Release](https://img.shields.io/github/tag/eventespresso/eea-flexible-payment-method.svg?style=flat&label=Latest%20Release)](https://github.com/eventespresso/eea-flexible-payment-method/releases)
[![Travis](https://travis-ci.org/eventespresso/eea-flexible-payment-method.svg?branch=master)](https://travis-ci.org/eventespresso/eea-flexible-payment-method)
...
[![Minimum EE Core Version:](https://img.shields.io/badge/Minimum%20EE%20core%20ver-4.6.0.p-red.svg)](https://github.com/eventespresso/event-espresso-core/releases/tag/4.6.0.p)

With this payment method, you can provide instructions to your registrants/attendees on how to pay for their registrations.
...
| **Some Links**|     |
|---- | --- |
**Support License** | Support for this add-on is not provided through this repository.  For support you can purchase a [Premium Support License](https://eventespresso.com/product/eea-flexible-payment-method?ee_ver=ee4&utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=premium+support+license). 
**Documentation** | [View Documentation →](https://eventespresso.com/wiki/flexible-payment-method?utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=view+addon+documentation)
